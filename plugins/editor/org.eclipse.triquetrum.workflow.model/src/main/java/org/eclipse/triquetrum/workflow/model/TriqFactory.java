...
public interface TriqFactory extends EFactory {
  ...
  /**
   * Returns a new object of class '<em>Named Obj</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Director</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Composite Entity</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Composite Actor</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
