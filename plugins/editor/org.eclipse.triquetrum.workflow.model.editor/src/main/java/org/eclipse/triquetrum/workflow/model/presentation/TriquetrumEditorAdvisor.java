 ...
 * @generated
 */
public final class TriquetrumEditorAdvisor extends WorkbenchAdvisor {
  /**
   * The default file extension filters for use in dialogs. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  private static final String[] FILE_EXTENSION_FILTERS = TriqEditor.FILE_EXTENSION_FILTERS.toArray(new String[0]);
  ...
  private static String getString(String key) {
    return TriquetrumEditorPlugin.INSTANCE.getString(key);
  }
  ...
  private static String getString(String key, Object s1) {
    return org.eclipse.triquetrum.workflow.model.presentation.TriquetrumEditorPlugin.INSTANCE.getString(key, new Object[] { s1 });
  }
  ...
  public static class Perspective implements IPerspectiveFactory {
     ...
     * @generated
     */
    public static final String ID_PERSPECTIVE = "org.eclipse.triquetrum.workflow.model.presentation.TriquetrumEditorAdvisorPerspective";
  ...
  public static class WindowAdvisor extends WorkbenchWindowAdvisor {
    ...
    /**
     * @see org.eclipse.ui.application.WorkbenchWindowAdvisor#createActionBarAdvisor(org.eclipse.ui.application.IActionBarConfigurer) <!-- begin-user-doc -->
     *      <!-- end-user-doc -->
     * @generated
     */
    @Override
  ...
  public static class WindowActionBarAdvisor extends ActionBarAdvisor {
    ...
    /**
     * Adds the specified action to the given menu and also registers the action with the action bar configurer, in order to activate its key binding. <!--
  ...
  /**
   * Open action for the objects from the Triquetrum model. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  public static class OpenAction extends WorkbenchWindowActionDelegate {
    /**
     * Opens the editors for the files selected using the file dialog. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
  ...
  /**
   * Open URI action for the objects from the Triquetrum model. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * @see org.eclipse.ui.application.WorkbenchAdvisor#createWorkbenchWindowAdvisor(org.eclipse.ui.application.IWorkbenchWindowConfigurer) <!-- begin-user-doc
   *      --> <!-- end-user-doc -->
   * @generated
   */
  @Override
