...
/**
 * This is the item provider adapter for a {@link org.eclipse.triquetrum.workflow.model.Annotation} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class AnnotationItemProvider extends AttributeItemProvider {
  ...
  protected void addTextPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Annotation_text_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Annotation_text_feature", "_UI_Annotation_type"),
        TriqPackage.Literals.ANNOTATION__TEXT, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  protected void addFontFamilyPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        TriqPackage.Literals.ANNOTATION__FONT_FAMILY, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }

  /**
   * This adds a property descriptor for the Text Size feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected void addTextSizePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Annotation_textSize_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Annotation_textSize_feature", "_UI_Annotation_type"),
        TriqPackage.Literals.ANNOTATION__TEXT_SIZE, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
  }
  ...
  protected void addBoldPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Annotation_bold_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Annotation_bold_feature", "_UI_Annotation_type"),
        TriqPackage.Literals.ANNOTATION__BOLD, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
  }
  ...
  protected void addItalicPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Annotation_italic_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Annotation_italic_feature", "_UI_Annotation_type"),
        TriqPackage.Literals.ANNOTATION__ITALIC, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
  }
  ...
  protected void addColorPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Annotation_color_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Annotation_color_feature", "_UI_Annotation_type"),
        TriqPackage.Literals.ANNOTATION__COLOR, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
