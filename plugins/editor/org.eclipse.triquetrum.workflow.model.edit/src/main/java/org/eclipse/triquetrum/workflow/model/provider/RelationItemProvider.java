...
/**
 * This is the item provider adapter for a {@link org.eclipse.triquetrum.workflow.model.Relation} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class RelationItemProvider extends NamedObjItemProvider {
  ...
  protected void addLinkedRelationsPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        TriqPackage.Literals.RELATION__LINKED_RELATIONS, true, false, true, null, null, null));
  }

  /**
   * This adds a property descriptor for the Linking Relations feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected void addLinkingRelationsPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        TriqPackage.Literals.RELATION__LINKING_RELATIONS, true, false, true, null, null, null));
  }

  /**
   * This adds a property descriptor for the Linked Ports feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected void addLinkedPortsPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Relation_linkedPorts_feature"), getString("_UI_PropertyDescriptor_description", "_UI_Relation_linkedPorts_feature", "_UI_Relation_type"),
        TriqPackage.Literals.RELATION__LINKED_PORTS, true, false, true, null, null, null));
  }
