...
/**
 * This is the item provider adapter for a {@link org.eclipse.triquetrum.workflow.model.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider extends NamedObjItemProvider {
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Port_input_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Port_input_feature", "_UI_Port_type"),
         TriqPackage.Literals.PORT__INPUT,
         true,
         false,
         false,
  ...
  protected void addLinkedRelationsPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Port_linkedRelations_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Port_linkedRelations_feature", "_UI_Port_type"),
         TriqPackage.Literals.PORT__LINKED_RELATIONS,
         true,
         false,
         true,
         null,
  ...
  /**
   * This adds a property descriptor for the Inside Linked Relations feature.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         TriqPackage.Literals.PORT__INSIDE_LINKED_RELATIONS,
         true,
         false,
         true,
         null,
