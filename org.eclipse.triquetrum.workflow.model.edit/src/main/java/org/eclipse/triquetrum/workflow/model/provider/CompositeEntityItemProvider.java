...
/**
 * This is the item provider adapter for a {@link org.eclipse.triquetrum.workflow.model.CompositeEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeEntityItemProvider extends EntityItemProvider {
  ...
  /**
   * This returns CompositeEntity.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_CompositeEntity_type") :
      getString("_UI_CompositeEntity_type") + " " + label;
  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add
      (createChildParameter
        (TriqPackage.Literals.COMPOSITE_ENTITY__ENTITIES,
         TriqFactory.eINSTANCE.createEntity()));

    newChildDescriptors.add
      (createChildParameter
        (TriqPackage.Literals.COMPOSITE_ENTITY__ENTITIES,
         TriqFactory.eINSTANCE.createCompositeEntity()));
    ...
    newChildDescriptors.add
      (createChildParameter
        (TriqPackage.Literals.COMPOSITE_ENTITY__RELATIONS,
         TriqFactory.eINSTANCE.createRelation()));
  }
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
    ...
    boolean qualify =
      childFeature == TriqPackage.Literals.ENTITY__INPUT_PORTS ||
      childFeature == TriqPackage.Literals.ENTITY__OUTPUT_PORTS;
