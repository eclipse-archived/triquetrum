...
import org.eclipse.triquetrum.workflow.model.presentation.TriquetrumEditorPlugin;
...
public final class TriquetrumEditorAdvisor extends WorkbenchAdvisor {
  ...
  /**
   * Open action for the objects from the Triquetrum model.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Open URI action for the objects from the Triquetrum model.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
