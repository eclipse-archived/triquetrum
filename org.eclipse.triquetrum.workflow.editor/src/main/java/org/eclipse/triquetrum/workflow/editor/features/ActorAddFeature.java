...
public class ActorAddFeature extends AbstractAddShapeFeature {
  ...
  public PictogramElement add(IAddContext context) {
    ...
    if(addedActor.getName().contains("Constant")) {
      GraphicsAlgorithm newGa = Graphiti.getGaCreateService().createPlatformGraphicsAlgorithm(containerShape, "const");
      gaService.setLocationAndSize(newGa, xLocation, yLocation, 60, 60);
