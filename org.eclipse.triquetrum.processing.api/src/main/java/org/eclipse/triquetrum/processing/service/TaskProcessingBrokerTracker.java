...
/**
 * A simple solution to easily allow access to the single {@link TaskProcessingBroker}
 * implementation instance that should be available in a Triquetrum runtime.
 * <p>
 * This avoids the complexity where everything that needs to access the broker instance
...
public class TaskProcessingBrokerTracker {
   ...
   * <p>
   * This method can be invoked e.g. from an activation method of the broker instance,
