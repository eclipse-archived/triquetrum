 ...
 * <p>
 * An <code>AttributeHolder</code> by assumption stores the attributes by their name, that should be unique within the holder. I.e. it can only contain one
...
public interface AttributeHolder {
  ...
  /**
   * Associate the attribute with this holder. If the holder already has an attribute with the same name, it will be replaced by this new one, and the previous
   * attribute will be returned.
   * 
   * @param attribute
   *          should be non-null
   * @return the attribute previously associated with this holder, with a same name as the new attribute. Or null if there was no attribute with the same name.
   */
